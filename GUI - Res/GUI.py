...
class ItemGUI(ctk.CTk):
    def __init__(self):
        ...
        self.customer_handler = CustomerHandling("mysql+pymysql://root:hello@localhost/pizza_db_new")
        self.item_handler = ItemHandling("mysql+pymysql://root:hello@localhost/pizza_db_new")
